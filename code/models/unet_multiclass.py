# code/models/unet_multiclass.py
# Multi-class 2D U-Net (3 output channels: background, liver, tumor)
...
# ------------------------------------------------------------
# Building blocks (identical to unet.py)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# U-Net architecture (multi-class)
# ------------------------------------------------------------
class UNetMultiClass(nn.Module):
    """
    Multi-class U-Net (3 output channels: background, liver, tumor).
    Returns raw logits suitable for CrossEntropyLoss.
    """
    def __init__(
        self,
        in_channels: int = 1,
        ...
        # Output head (3 channels instead of 1)
...
if __name__ == "__main__":
    model = UNetMultiClass(in_channels=1, n_classes=3, base_ch=32, dropout=0.5, use_transpose=False)
    x = torch.randn(2, 1, 256, 256)
    y = model(x)
    print("Output shape:", y.shape)   # expect (2, 3, 256, 256)
